...
def get_best_match(corrected_reads, reference_transcripts, outfolder, params):
    ...
    summary_file.write(
        "{0},{1},{2},{3},{4},{5},{6},{7},{8}\n".format(total_read_nucleotides, tot_errors, all_s, all_i, all_d,
                                                       round(100 * tot_errors / float(total_read_nucleotides), 3),
                                                       round(100 * all_s / float(total_read_nucleotides), 3),
                                                       round(100 * all_i / float(total_read_nucleotides), 3),
                                                       round(100 * all_d / float(total_read_nucleotides), 3)))
