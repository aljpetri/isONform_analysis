...
#the following line is without isONclust: This has to be included again
#/usr/bin/time -v python3.11 /proj/snic2022-6-31/nobackup/alexp/isONcorrect/run_isoncorrect --t $num_cores  --fastq_folder $outfolder/clustering/fastq_files  --outfolder $outfolder/correction/
...
/usr/bin/time -v python3.11 $isONform_folder/isONform_parallel.py --t $num_cores --fastq_folder $outfolder/correction/ --exact_instance_limit 50 --k 20 --w 31 --xmin 14 --xmax 80 --max_seqs_to_spoa 200 --delta_len 10 --outfolder $outfolder/isoforms --iso_abundance $iso_abundance --split_wrt_batches --merge_sub_isoforms_3  --merge_sub_isoforms_5 --delta_iso_len_3 30 --delta_iso_len_5 100 --slow
echo
