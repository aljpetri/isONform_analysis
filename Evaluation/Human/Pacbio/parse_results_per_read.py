...
def main(args):
    ...
    print()
    venn3([nic_isON,nic_stringtie,nic_RATTLE],('IsONform', 'Stringtie', 'RATTLE'))
    plt.title("NICs found")
    plt.show()
    ...
    venn3([isONform_fsms, stringtie_is_fsms, rattle_fsms], ('IsONform', 'Stringtie', 'RATTLE'))
    plt.title("FSMs found")
    plt.show()
