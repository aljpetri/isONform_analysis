...
do
	...
	echo "RATTLE cluster"
	$rattle_loc/rattle cluster -i $file -t 24 -o $rattle_dir  --rna 
	echo "RATTLE correct"
	$rattle_loc/rattle correct -i $file -c $rattle_dir"/clusters.out"  -o $rattle_dir -t 24
	echo "RATTLE polish"
	$rattle_loc/rattle polish -i $rattle_dir"/consensi.fq" -o $rattle_out_file -t24 --rna
	echo "Polished"
