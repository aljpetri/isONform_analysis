...
FILES=$filedirectory"/reads/*.fastq"
	...
	$isonform_dir/pipeline_simulations.sh $actual_file $filedirectory/isONpipe/$number 8 $isonform_dir $iso_abundance
	...
	#if test -f "$FILE"; then
	mv $filedirectory/isONpipe/$number/isoforms/transcriptome.fastq  $filedirectory/isONcorrform/cl_spoa_$number.fastq
	mv $filedirectory/isONpipe/$number/isoforms/transcriptome_support.txt $filedirectory/isONcorrform/support_$number.txt
	mv $filedirectory/isONpipe/$number/isoforms/transcriptome_mapping.txt $filedirectory/isONcorrform/mapping_$number.txt
	#else
